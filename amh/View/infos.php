...
<p class="ico ip"><font>IP地址 :</font> <?php echo $IP[1];?></p><br>
...
<br><br><br>
<p class="ico hd"><font>硬盘 :</font> <span class="lines <?php echo $hd_color;?>"><span class="lines_val" style="width:<?php echo $hd_percentage;?>%;"></span><span class="lines_txt"><?php echo $HD[1];?></span></span></p><br>
